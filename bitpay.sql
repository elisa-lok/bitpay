...
CREATE TABLE `think_ad_sell` (
 ...
 `ad_no` varchar(15) NOT NULL COMMENT '挂单唯一编号',
 `userid` int(11) NOT NULL COMMENT '发布用户id',
 `location` int(10) NOT NULL DEFAULT '0' COMMENT '地区',
 `currency` int(10) NOT NULL DEFAULT '0' COMMENT '货币',
 `margin` decimal(8,4) NOT NULL DEFAULT '0.0000' COMMENT '溢价',
 `min_price` decimal(14,4) DEFAULT '0.0000',
 `min_limit` decimal(14,4) NOT NULL DEFAULT '0.0000',
 `max_limit` decimal(14,4) NOT NULL DEFAULT '0.0000',
 ...
 `coin` int(10) NOT NULL DEFAULT '0',
 `fee` decimal(8,4) DEFAULT '0.0000',
 ...
 `pay_method2` int(11) NOT NULL DEFAULT '0' COMMENT '支付宝',
 `pay_method3` int(11) NOT NULL DEFAULT '0' COMMENT '微信',
 `pay_method4` int(11) NOT NULL DEFAULT '0' COMMENT '云闪付',
 `trading_volume` decimal(20,8) DEFAULT '0.00000000',
 `remain_amount` decimal(20,8) DEFAULT '0.00000000',
 PRIMARY KEY (`id`),
 UNIQUE KEY `ad_no` (`ad_no`) USING BTREE,
 KEY `userid` (`userid`) USING BTREE,
 KEY `currency` (`currency`) USING BTREE,
...
(31,'send_message_content','您的挂单{tx_id}买家已付款，数量{usdt}，交易码{check_code},点此处理{url}'),
...
CREATE TABLE `think_order_buy` (
  ...
  `check_code` varchar(6) NOT NULL COMMENT '校验码',
  `actual_amount` decimal(13,2) NOT NULL DEFAULT '0.00' COMMENT '实际收取金额',
  PRIMARY KEY (`id`),
